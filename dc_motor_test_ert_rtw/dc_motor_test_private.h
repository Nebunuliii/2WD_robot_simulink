...
#ifndef RTW_HEADER_dc_motor_test_private_h_
#define RTW_HEADER_dc_motor_test_private_h_
#include "rtwtypes.h"
...
#endif                                 /* RTW_HEADER_dc_motor_test_private_h_ */
